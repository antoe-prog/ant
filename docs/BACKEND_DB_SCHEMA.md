...
- 회원 삭제 감사 스냅샷은 삭제된 회원의 실명·주소·생년월일·연락처와 자유 입력 삭제 사유 원문을 남기지 않고, 사유 확인 여부·지점·연령 구분·상태와 삭제된 운영 기록 건수만 2년간 보관한다. 2년 만료 시 DB 쓰기 전 정리와 승인된 일일 정리 경로에서 삭제하며, 법정 결제 원장의 5년 보유는 독립적으로 유지한다.
