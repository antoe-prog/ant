        ...
        <FlatList
          ...
          ListEmptyComponent={
            <View className="items-center py-12 px-4">
              ...
              {(members?.length ?? 0) === 0 ? (
                <Text className="text-muted text-center">등록된 회원이 없습니다</Text>
              ) : (
                <>
                  <Text className="text-muted text-center mb-3">조건에 맞는 회원이 없습니다.</Text>
                  <TouchableOpacity className="px-4 py-2 rounded-full border border-border" onPress={resetFilters}>
