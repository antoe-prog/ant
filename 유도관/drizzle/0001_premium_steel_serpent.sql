...
--> statement-breakpoint
ALTER TABLE `users` MODIFY COLUMN `role` enum('employee','hr','manager','admin') NOT NULL DEFAULT 'employee';--> statement-breakpoint
...
ALTER TABLE `users` ADD `startDate` timestamp;--> statement-breakpoint
