...
- **데이터가 분할·분사 미조정이다.** 하루에 -30% 넘게 빠진 봉이 13건 있는데
  전부 코퍼레이트 액션이다 (EBAY의 PayPal 분사 -57%, NI -63%, BAX -44%, DISCA
  -51%, LNT -49% 등). 이 가짜 급락에서 **손절이 발동해 전략이 '폭락을 피한'
  것처럼 보이고**, 바이앤홀드는 회복 못 하는 손실을 떠안는다.
  13개 중 8개가 '전략 승'으로 집계됐으니 **69승 중 최대 11%가 인공물이다.**
  실제 승률은 14.7%보다 낮다.
