...
const checks = [
  ...
  ["run", "test:unit"],
  ["run", "test:adversarial-design-fixes"],
  ...
  ["run", "test:attendance-mutation-safety"],
  ["run", "test:auth-production-guard"],
  ["run", "test:phone-signup-security"],
  ["run", "test:phone-signup-login-flow"],
  ["run", "test:password-reset-security"],
  ["run", "test:google-play-review-access"],
  ["run", "test:google-play-review-api"],
  ["run", "test:public-legal-pages"],
  ...
  ["run", "test:mobile-notification-inbox"],
  ["run", "test:pilot"],
  ...
  ["run", "test:notice-compose-safety"],
  ["run", "test:routes"],
  ["run", "test:e2e"],
  ["run", "test:smoke"],
