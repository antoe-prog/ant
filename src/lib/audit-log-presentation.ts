...
export const auditActionLabels: Record<AuditAction, string> = {
  ...
  "counseling_note.update": "상담 메모 수정",
  "counseling_note.delete": "상담 메모 삭제",
  ...
  "tournament.sync": "대한유도회 일정 동기화",
  "tournament.registration.update": "대회 참가 신청 변경",
  "class.create": "수업 생성",
  "class.update": "수업 변경",
...
const auditPayloadValueLabels: Record<string, string> = {
  ...
  generated: "자동 발급",
  guardian: "학부모",
  guardian_visible: "학부모에게 공유",
  inactive: "비활성",
  late: "지각",
  manual: "수동",
  member: "회원",
  member_visible: "회원에게 공유",
  monitoring: "확인 중",
  overdue: "미납",
  owner: "대표",
  paid: "납부 완료",
