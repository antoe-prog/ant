    ...
    >
      <div className="flex items-start gap-3 px-1">
        ...
        <div className="min-w-0">
          <h2 className="text-base font-bold text-zinc-950" id="final-main-schedule-title">
            {branchName} 운영 시간표
          </h2>
          <p className="mt-1 text-sm text-zinc-600">전 연령 오픈 수업 기준이며 출석 명단은 아래 실제 수업에서 확인합니다.</p>
        </div>
      </div>

      <dl className="mt-4 divide-y divide-zinc-100 border-y border-zinc-100 text-sm">
      ...
      {todayProgram ? (
        <div className="mt-4 px-1" data-testid="final-main-today-training-program">
        ...
        <p className="mt-4 px-1 text-sm font-medium text-zinc-500">오늘은 요일별 정규 훈련 프로그램이 없습니다.</p>
      )}

      <p className="mt-4 border-t border-zinc-100 px-1 pt-3 text-xs leading-5 text-zinc-500">
        선수부 17:00–19:00 / 19:00–22:00 · 입시 준비 20:00–23:00 협의 · 경찰·군인·소방 및 단 준비는 일정 협의
      </p>
    </section>
  );
}
