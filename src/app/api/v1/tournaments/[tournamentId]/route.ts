...
export async function PATCH(
  ...
  const nextTournament = { ...tournament, ...validated.value, updatedAt: now };
  const auditLog: AuditLog = {
    ...
    before: { title: tournament.title, organizer: tournament.organizer, eventDate: tournament.eventDate },
    after: { title: nextTournament.title, organizer: nextTournament.organizer, eventDate: nextTournament.eventDate },
    result: "success",
